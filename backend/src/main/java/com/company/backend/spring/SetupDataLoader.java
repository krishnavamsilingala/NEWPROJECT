...
import com.company.backend.persistence.dao.PrivilegeRepository;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        createRoleIfNotFound("ROLE_SOCIALUSER",userPrivileges);
        ...
        userr.setFirstName("Test2");
        userr.setLastName("Test2");
        userr.setPassword(passwordEncoder.encode("test2"));
        userr.setEmail("test@test2.com");
        userr.setRoles(Arrays.asList(userrole));
